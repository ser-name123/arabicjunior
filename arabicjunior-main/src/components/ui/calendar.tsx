    ...
    <DayPicker
      ...
      components={{
        IconLeft: ({ className, ...props }) => (
          <ChevronLeft className={cn("h-4 w-4 flex-shrink-0 flex-grow-0 basis-auto", className)} {...props} />
        ),
        IconRight: ({ className, ...props }) => (
          <ChevronRight className={cn("h-4 w-4 flex-shrink-0 flex-grow-0 basis-auto", className)} {...props} />
        ),
      }}
      {...props}
    />
