...
import faqSectionRoutes from "./routes/faqSectionRoutes";
import teachersPageRoutes from "./routes/teachersPageRoutes";
import pricingPageRoutes from "./routes/pricingPageRoutes";
import contactSeoSectionRoutes from "./routes/contactSeoSectionRoutes";
...
connectDB()
  .then(() => {
    ...
    app.use("/", faqSectionRoutes);
    app.use("/", teachersPageRoutes);
    app.use("/", seoMetaRoutes);
    app.use("/", contactSeoSectionRoutes);
    app.use("/", pricingPageRoutes);
